...
# Sources and Types of Data {#sourcesanddtypes}
...
knitr::include_graphics("DataExampleSA.png")
```
...
knitr::include_graphics("PieChartNominal.png")
```
...
knitr::include_graphics("BarChartNominal.png")
```
...
knitr::include_graphics("HistogramOrdinal.png")
```
...
knitr::include_graphics("BoxPlotInterval.png")
```
...
knitr::include_graphics("HistogramRatio.png")
```
...
knitr::include_graphics("Temps.png")
```
...
#par(mfrow=(c(2,2)))
knitr::include_graphics(c("Sat.jpg","POIs.jpg","Roads.jpg","Overlaid.jpg"))
