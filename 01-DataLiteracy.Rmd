...
# An Overview of Data literacy {#ch1}
...
```{r fig1, echo=FALSE,fig.align='center', fig.cap="A heatmap of South Africa showing the HIV prevalence rate in each province in 2022",out.width="80%"}
knitr::include_graphics("images/HIV-Prevalence_2022.png")
```
...
From Figure \@ref(fig:fig1), we can see that, in 2022, the Western Cape and Northern Cape had the lowest HIV prevalence (8.2 – 11.6%).

2.  The figure below (Figure \@ref(fig:fig2) shows a map (from an article in the September 30, 2024 issue of the *Wall Street Journal*) of the United States of America (USA) as a heatmap. For each state of the USA, the map displays the share of the total power consumed by data centers in 2023. The lighter the section on the map, the less the share of the power consumed by data centers.

```{r fig2, echo=FALSE, fig.align='center', fig.cap="A heatmap of the United States showing the data centers' share of total power consumption by state in 2023",out.width="80%"}
knitr::include_graphics("images/Data_Centers.png")
```

From Figure \@ref(fig:fig2), we can see that in the state of Michigan (Mich.), for instance, data centers consume a small share (0 – 3%) of the total power consumed by the state. Whereas, in the state of Virginia (Va.) data centers consume a large share (26%) of the total power consumed in the state.
...
```{r crosstab1, echo=FALSE, out.width="30%",fig.align='center'}
knitr::include_graphics("Figures-Chapter1/Simpson.png")
```
...
```{r, eval=knitr::is_html_output(excludes = "epub"), results = 'asis', echo = FALSE,fig.align='center',out.width="30%"}
cat(
'<iframe width="560" height="315" src="https://www.youtube.com/embed/vqKdLF_VzZE?si=uG1PvTdj7DA1Oky5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>'
)
```
...
Answer the following questions based on Figure \@ref(fig:fig1).
...
Answer the following questions based on Figure \@ref(fig:fig2).
...
```{r figshp, echo=FALSE, fig.cap="Shoprite Revenue for the period 2014 to 2023"}
knitr::include_graphics("images/clipboard-3088691256.png")
```
...
```{r figFNB, echo=FALSE,out.width="60%",fig.cap="The Quarterly FNB/BER Consumer Confidence Index for the period 2014 (1st Quarter) - 2024 (2nd Quarter)"}
knitr::include_graphics("images/clipboard-2186963206.png")
```
...
```{r covid-2,out.width="70%",echo=FALSE,fig.align='center',fig.cap="Same as Figure \\@ref(fig:covid-1)"}
...
2.  **Data collection**
    ...
    Once the study is defined, the next step is to collect the relevant data. This can be done using various methods to be discussed in Chapter \@ref(ch4). The choice of method used to collect data depends on the nature of the problem and the questions being asked.
...
There are many techniques used in data analysis and each one serves a unique purpose and application. In section \@ref(sec1-5), we discussed data exploration. This is the most basic technique for data analysis. In this section, we will briefly discuss some of the most commonly used and emerging techniques.
