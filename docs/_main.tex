...
\includegraphics[width=0.3\linewidth]{Figures-Chapter1/Simpson}
...
\caption{A box-and-whisker plot showing an outlier}\label{fig:unnamed-chunk-2}
\end{figure}
...
\caption{Scatter plot of electric vehicle sales (in R millions) and the number of advertisements}\label{fig:unnamed-chunk-3}
\end{figure}
