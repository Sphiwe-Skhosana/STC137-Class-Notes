...
In modern society, \textbf{data} is everywhere. It is collected when we
...
\section{Example: Super Animals}\label{example-super-animals}
...
\begin{center}\includegraphics[width=0.2\linewidth]{Figures/super-animals} \includegraphics[width=0.2\linewidth]{Figures/super-animals2} \end{center}

The information from these cards are collected in a data set called \texttt{super-animals.xlsx}.

\subsection*{The VLOOKUP function}\label{the-vlookup-function}
